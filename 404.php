    ...
    <div class="archive-page search-page">
        ...
        <div class="main-grid">
            ...
            <div class="posts-area">
                ...
                <!-- POSTS Section -->
                <h1 class="section-heading">Sorry This Page Was Not Found!</h1>

                <div class="no-results">

                    <p class="para">Try visting our <a href="<?php echo home_url();?>">Homepage</a>, <a href="<?php echo home_url('/posts');?>">Latest Posts</a>, or <a href="<?php echo home_url('/services');?>">Our Services</a></p>
