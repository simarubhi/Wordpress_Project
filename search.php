    ...
    <div class="archive-page search-page">
        ...
        <div class="main-grid">
            ...
            <div class="posts-area">
                ...
                <!-- POSTS Section -->
                <h1 class="section-heading">Showing Search Results For "<?php echo get_search_query();?>"</h1>
                ...
                <div class="no-results">
                    ...
                    <h1 class="heading">Sorry There Were No Posts Found!</h1>

                    <p class="para">Try searching for something else or vist our <a href="<?php echo home_url();?>">Homepage</a>, <a href="<?php echo home_url('/posts');?>">Latest Posts</a>, or <a href="<?php echo home_url('/services');?>">Our Services</a></p>
